...
import (
	...
	"github.com/sagernet/sing-box/cloudflare/ipscanner/iputils"
)
...
func AllWarpPrefixes() []netip.Prefix {
	return WarpPrefixes(0)
}
...
func IsPeerCloudflareWarp(publicKey string) bool {
	if publicKey == "bmXOC+F1FxEMF9dyiK2H5/1SUtzH0JuVo51h2wPfgyo=" {
		return true
	}
